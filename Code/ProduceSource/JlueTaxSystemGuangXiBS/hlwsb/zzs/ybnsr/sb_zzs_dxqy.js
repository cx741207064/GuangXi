...
var sb_zzs_dxqy = (function() {
    ...
    return {
        ...
        onPrint: function () {
            ...
            window.location = "/hlwsb/zzs_print/ybnsr/sb_zzs_dxqy.html?" + str;
        },
        onLoad : function() {
            ...
            dcell(DCellWeb1, "/hlwsb/printModel/zzs/ybnsr/sb_zzs_dxqy.cll");
        ...
        onQuery : function() {
            ...
            baseTools.xhrAjax({
                url : "/hlwsb/zzs/ybnsr/getSB_ZZS_DXQYFZJGQDJXSEQK.do",
                params : {
                    SBBZL_DM : SBBZL_DM,
                    SSSQ_Q:SSSQ_Q,SSSQ_Z:SSSQ_Z,NSRLX_DM : NSRLX_DM
                },
        ...
        onSave : function() {
            ...
            var map3 = DCellWeb1.submitJsonjs({
                cols: [ "XSE", "YSK", "YZL","YJSE","CBXSE","SYSL","CBSE","BZ"],
                returnType: "object" ,
                headCols:["TBRQ", "SSSQ", "NSRMC"]
            });

            //扩展多个body
            var map4 = DCellWeb1.cellRowToJson({
                cols: ["HC","PZZL", "JE", "JXSE", "SKSBJJSFWF","RZJHYF","BZ2"],
                cellRows: [
                    {start: "HC", end: "HJ"}
                ],
                returnType: "object"
            ...
            var url = "/hlwsb/zzs/ybnsr/insertSB_ZZS_DXQYFZJGQDJXSEQK.do";
            baseTools.xhrAjax({
                url: url,
                params: {DATA1: JSON.stringify(map3),DATA2: JSON.stringify(map4), SBBXH: SBBXH, SBBZL_DM: SBBZL_DM, SSSQ_Q: SSSQ_Q, SSSQ_Z: SSSQ_Z},
                callback: [curSeg.pageFlowControl]
            });
        ...
        onDelete:function() {
            ...
            if (confirm("确定删除此报表？")) {
                ...
                var url = "/hlwsb/zzs/ybnsr/delSB_ZZS_DXQYFZJGQDJXSEQK.do";
                baseTools.xhrAjax({
                    url : url,
        ...
        initData : function(jsonObj) {
            ...
            DCellWeb1.setValByLabel("G7", "0.10");
            DCellWeb1.setValByLabel("G8", "0.10");
            DCellWeb1.setValByLabel("G9", "0.10");
            DCellWeb1.setValByLabel("G10", "0.10");
            // 页面控制参数
                ...
                cellRows: [
                    {start: "HC",
                        ...
                        delButton :  {name:"DelButton",
                            checkbox : "CZ",
                            url:"/hlwsb/zzs/ybnsr/delSB_ZZS_DXQYFZJGQDJXSEQKByHC.do",
                            params:{SBBXH: SBBXH}
                        }
                    }
                ],
            ...
            DCellWeb1.initDataToCell({
                cols: [ "XSE", "YSK", "YZL","YJSE","CBXSE","CBSE","BZ","COUNT"],
                data: map1,
...
//          DCellWeb1.setValByLabel("D7", "0.03");
           /* DCellWeb1.setValByLabel("G11", "0.10");*/

            var YZL_FLG = jsonObj.data.YMKZ.YZLFZJGZG;
            var dxqybz = jsonObj.data.YMKZ.dxqybz;
            if("Y"==dxqybz){
                document.getElementById("save").disabled = false;
                document.getElementById("delete").disabled = false;
                document.getElementById("print").disabled = false;
            }else {
            	DCellWeb1.setValByLabel("A2","非电信企业不需要填报该表！");
                document.getElementById("save").disabled = true;
                document.getElementById("delete").disabled = true;
                document.getElementById("print").disabled = true;
                DCellWeb1.setCellInputByLabel("I17", 5);
                DCellWeb1.setCellInputByLabel("I18", 5);
            }
            if (jsonObj.data.HEAD.SBBZT) {
                bAdd = false;
            }
     ...
     */
        ...
        openPopWin: function () {
            ...
            var winParam = {
                ...
                url: '/hlwsb/components/excelToJson/sb_excel_upload.html?bbmc=sb_zzs_dxqy&&startRow=8&&sheetIndex=1&templatePath=../../printModel/zzs/ybnsr/sb_zzs_dxqy.zip',
                width: 400,
                height: 150
            };
