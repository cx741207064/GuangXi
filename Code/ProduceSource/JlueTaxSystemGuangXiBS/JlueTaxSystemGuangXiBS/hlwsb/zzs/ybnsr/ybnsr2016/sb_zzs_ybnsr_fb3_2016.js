...
var fb3 = (function () {
    ...
    return {
        ...
        onLoad: function () {
            curSeg = fb3;
            //引用报表控制
            dcell(DCellWeb1, "/hlwsb/printModel/zzs/ybnsr/ybnsr2016/sb_zzs_fb3_2016.cll");
            curSeg.onQuery();
        ...
        onPrint: function () {
            ...
            window.location = "/hlwsb/zzs_print/ybnsr/ybnsr2016/sb_zzs_ybnsr_fb3_2016.html?" + str;
        },
        //查询数据
        onQuery: function () {
            ...
            baseTools.xhrAjax({
                url: url,
                params: {
                    SBBZL_DM: SBBZL_DM, SSSQ_Q: SSSQ_Q, SSSQ_Z: SSSQ_Z
                },
