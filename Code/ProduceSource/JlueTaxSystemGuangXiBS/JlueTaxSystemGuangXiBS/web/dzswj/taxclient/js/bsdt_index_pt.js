                ...
                "columnDefs": [{
                        ...
                        "render": function (data, type, full, meta) {
                        	if(full.CZDZ!=null&&full.CZDZ!=''){
                        		return '<a href="#"><span class="btn wxl_bg_lan1" onClick="javascript:bsdt_msg.msgBL(\'' + full.SXMC + '\',\'' + full.ID + '\',\'' + full.YWID + '\',\'' + full.CZDZ + '\',\'' + full.XTDM + '\');">办理</span><span class="btn wxl_bg_yel"  onClick="return false;javascript:bsdt_msg.msgHL(\'' + full.ID + '\');">忽略</span></a>';
                        	}else{
                        		return data;
                        	}
                        },
