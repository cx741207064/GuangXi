<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SB104xqykjzzcwbsCtrl_toSbfb_03.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SB104xqykjzzcwbsCtrl_toSbfb_03" %>
...
<html>
	<head>
		...
		<script language='javascript' type='text/javascript'
			src='../../sb/sb104/sb104_lrbnbb.js'></script>
<script type="text/javascript" src="/gt3_public/cacheindex.js"></script>
	...
	<!-- 缓存 -->
		<div class="wrapper">
			...
			<div sword="SwordForm" name="nsrxxForm4" caption="纳税人基本信息"
			...
			<div sword="SwordForm" name="lrbxxnbbForm"
				caption="利润表(适用执行小企业会计准则的企业)" panel="true" userdefine="true">
				<table class="tab_form" border="0" cellpadding="0" cellspacing="0">
					<colgroup>
						<col style="width: 35%" />
						<col style="width: 5%" />
					...
					<tr>
						...
						<td>
							<div name="h3l3" type="text" defValue="0.00"
								rule="must_number_customFunction;formTestb()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div name="h11l2" type="text" defValue="0.00"
								rule="must_number_customFunction;formTest2()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h11l3" type="text" defValue="0.00"
								rule="must_number_customFunction;formTestb2()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div name="h14l2" type="text" defValue="0.00" rule="must_number"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h14l3" type="text" defValue="0.00"
								rule="must_number_customFunction;formTestb3()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div name="h18l2" type="text" defValue="0.00" rule="must_number"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h18l3" type="text" defValue="0.00"
								rule="must_number_customFunction;formTestb4()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div name="h22l3" type="text" defValue="0.00"
								rule="must_number_customFunction;formTestb6()"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
...
<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"e84fdc4035e543cdbcf764b133f5e4d9","type":""}]}'></div>
