<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_cwkjzdba_cwkjzdbaList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_cwkjzdba_cwkjzdbaList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<html>
<head>
	<title>财务会计制度备案</title>
    ...
    <script type="text/javascript" src="/WSSBSL/js/page/cwkjzdba/cwkjzdbaList.js?ts=new Date().getTime()"></script>
		...
		<table width="100%" >
			<tr><td align="left">
				...
				<td align="right" width="350">
					<a id="addRow" href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="addRow()">添加行</a>
					<a id="delRow" href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'" onclick="delRow()">删除行</a>
					<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-redo'" onclick="submitTableData()">提交备案</a>
					&nbsp;&nbsp;
				</td>
			</tr>
		</table>
