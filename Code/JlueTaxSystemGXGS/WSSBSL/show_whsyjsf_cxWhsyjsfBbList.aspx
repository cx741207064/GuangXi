<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_whsyjsf_cxWhsyjsfBbList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_whsyjsf_cxWhsyjsfBbList" %>
...
<script type="text/javascript" src="/WSSBSL/js/page/whsyjsf/cxWhsyjsfBbList.js?ts=new Date().getTime()"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
...
<body>  
 	<div class="easyui-panel" id="cxtjDiv" align="left" style="width:auto;background-color:#E0ECFF" data-options="iconCls:'icon-search'">
 		<form id="searchForm">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="loadWhsyjsfList()">查 询</a>
		</form>
 	</div>
