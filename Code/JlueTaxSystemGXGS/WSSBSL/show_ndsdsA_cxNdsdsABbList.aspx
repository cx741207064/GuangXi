<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_ndsdsA_cxNdsdsABbList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_ndsdsA_cxNdsdsABbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>申报数据查询-企业所得税年度（A类）</title>
...
<script type="text/javascript" src="/WSSBSL/js/page/ndsdsA/cxNdsdsABbList.js"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
...
<body>  
 	<div class="easyui-panel" id="cxtjDiv" align="left" style="width:auto;background-color:#E0ECFF" data-options="iconCls:'icon-search'">
 		<form id="searchForm">
			&nbsp;
	 		查询时间起：<input id="cxsjQ" name="cxsjQ" class="easyui-validatebox" data-options="required:true" size="12" style="cursor: pointer" onclick="WdatePicker({dateFmt:'yyyy',minDate:'2015-01-01'})"/>
			查询时间止：<input id="cxsjZ" name="cxsjZ" class="easyui-validatebox" data-options="required:true" size="12" style="cursor: pointer" onclick="WdatePicker({dateFmt:'yyyy',minDate:'2015-01-01'})"/>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="loadNdsdsAList()">查 询</a>
		</form>
 	</div>
