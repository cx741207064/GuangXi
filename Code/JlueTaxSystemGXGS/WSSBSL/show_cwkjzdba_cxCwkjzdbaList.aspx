<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_cwkjzdba_cxCwkjzdbaList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_cwkjzdba_cxCwkjzdbaList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>申报数据查询-财务会计制度备案</title>
...
<script type="text/javascript" src="/WSSBSL/js/page/cwkjzdba/cxCwkjzdbaList.js"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
	...
	<div class="easyui-panel" id="cxjgDiv" align="left" style="height:100px; data-options="iconCls:'icon-ok'">
 		<table id="sbxxList" border="0" align="center" width="100%" 
			...
			<tr>
				...
				<th bgcolor="#E0ECFF" align="center" >有效期起</td>
				<th bgcolor="#E0ECFF" align="center" >有效期止</td>
