...
{
    /// <summary>
    /// do_index_Index_loadBbtbList 的摘要说明
    /// </summary>
    public class do_index_Index_loadBbtbList : IHttpHandler, IReadOnlySessionState
    {

        public void ProcessRequest(HttpContext context)
        {
            //string jsonResult = "";
            //jsonResult = File.ReadAllText(context.Server.MapPath("/WSSBSL/JSON/do_index_Index_loadBbtbList.json"));
            ...
            if (userysbqc.IsSuccess)
            {
                ...
                if (userysbqclist.Count > 0)
                {
                    ...
                    {
                        reportidstr.Append(item.reportid + ",");
                    }
