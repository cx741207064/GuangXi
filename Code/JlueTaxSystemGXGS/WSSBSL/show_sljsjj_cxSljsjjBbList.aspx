<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_sljsjj_cxSljsjjBbList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_sljsjj_cxSljsjjBbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>申报数据查询-水利建设基金</title>
...
<script type="text/javascript" src="/WSSBSL/js/page/sljsjj/cxSljsjjBbList.js?ts=new Date().getTime()"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
...
<body>  
	...
	<div class="easyui-panel" id="cxtjDiv" align="left" style="width:auto;background-color:#E0ECFF" data-options="iconCls:'icon-search'">
 		<form id="searchForm">
			...
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="loadSljsjjList()">查 询</a>
		</form>
 	</div>
