<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_zzsxgm_cxZzs2013XgmBbList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_zzsxgm_cxZzs2013XgmBbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>申报数据查询-增值税小规模</title>
...
<script type="text/javascript" src="/WSSBSL/js/page/zzsxgm/cxZzs2013XgmBbList.js?ts=new Date().getTime()"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
