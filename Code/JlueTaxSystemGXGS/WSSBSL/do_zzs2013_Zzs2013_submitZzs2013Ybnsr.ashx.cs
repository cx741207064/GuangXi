...
{
    /// <summary>
    /// do_zzs2013_Zzs2013_submitZzs2013Ybnsr 的摘要说明
    /// </summary>
    public class do_zzs2013_Zzs2013_submitZzs2013Ybnsr : IHttpHandler, IReadOnlySessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            GTXResult ysbqcmodelresult = GTXMethod.GetSCYSBQCByUserYSBQCId(_userYSBQCId);
            {
                if (ysbqcmodelresult.IsSuccess)
                {
                    ...
                    if (Regex.Matches(ysbqcmodel.tbqk, @"1").Count >= 7)
                    {
