<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show_jdsds2012_cxJdsds2012ABbList.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.show_jdsds2012_cxJdsds2012ABbList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>申报数据查询-季度所得税</title>
...
<script type="text/javascript" src="/WSSBSL/js/page/jdsds2012/cxJdsds2012ABbList.js?ts=new Date().getTime()"></script>
	<style type="text/css">
		form {
			margin: 0;
			padding:0;
...
<body>  
 	<div class="easyui-panel" id="cxtjDiv" align="left" style="width:auto;background-color:#E0ECFF" data-options="iconCls:'icon-search'">
 		<form id="searchForm">
			&nbsp;
	 		所属时期起：<input id="cxsjQ" name="cxsjQ" class="easyui-validatebox" data-options="required:true" size="12" style="cursor: pointer" onclick="WdatePicker({dateFmt:'yyyy-MM'})"/>
			所属时期止：<input id="cxsjZ" name="cxsjZ" class="easyui-validatebox" data-options="required:true" size="12" style="cursor: pointer" onclick="WdatePicker({dateFmt:'yyyy-MM'})"/>
			<a href="javascript:void(0)" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-search'" onclick="loadJdsdsAList()">查 询</a>
		</form>
 	</div>
	...
	<div id="tab-tools">
		...
		<a href="javascript:void(0)" class="easyui-menubutton" data-options="menu:'#otherMenu',iconCls:'icon-print'" onclick="">打印报表</a>	</div>
	<div id="otherMenu">
