<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showReport_ybnsrFb2_bc.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showReport_ybnsrFb2_bc" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_11336";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&columns=0&srcType=file&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&columns=0&srcType=file&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&srcType=file&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=15127051901069570111065&cachedId=10_1_1_176_8080_11336&t_i_m_e=1512705190371";
	}
</script>
...
<style id="report1_style">
	...
	.report1_7 { text-align:center;vertical-align:middle;font-family:宋体;font-size:12px;color:#0000FF;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#E1E1E1;white-space:nowrap;overflow:hidden;word-break:keep-all;}
	...
	.report1_9 { text-align:center;vertical-align:middle;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#E1E1E1;line-height:16px;}
	...
	.report1_13 { text-align:right;vertical-align:middle;font-family:宋体;font-size:12px;color:#009900;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#E1E1E1;white-space:nowrap;overflow:hidden;word-break:keep-all;}
...
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1427586out()" onmouseover="report1427586over()" rowCount=49 cols=9 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:648px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=35 style="height:35px;">
		<td colSpan=9 id="report1_A1" colNo=1 value='46505358' onclick="_hideEditor()" class="report1_3">增值税纳税申报表附列资料（表二）</td>
	</tr>
	...
	<tr rn="3" height=20 style="height:20px;">
		...
		<td colSpan=3 id="report1_B3" colNo=2 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td id="report1_E3" colNo=5 value='填表日期' onclick="_hideEditor()" class="report1_4">填表日期</td>
		<td colSpan=2 id="report1_F3" colNo=6 value='2017-12-08' onclick="_hideEditor()" class="report1_4">2017-12-08</td>
		<td colSpan=2 id="report1_H3" colNo=8 value='金额单位：元(列至角分)' onclick="_hideEditor()" class="report1_4">金额单位：元(列至角分)</td>
	</tr>
	<tr rn="4" height=35 style="height:35px;">
		<td id="report1_A4" colNo=1 value='纳税人名称' onclick="_hideEditor()" class="report1_8">纳税人名称</td>
		<td colSpan=3 id="report1_B4" colNo=2 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td id="report1_E4" colNo=5 value='所属日期' onclick="_hideEditor()" class="report1_4">所属日期</td>
		<td colSpan=2 id="report1_F4" colNo=6 value='' onclick="_hideEditor()" class="report1_4"></td>
		<td id="report1_H4" colNo=8 value='至' onclick="_hideEditor()" class="report1_4">至</td>
		<td id="report1_I4" colNo=9 value='' onclick="_hideEditor()" class="report1_4"></td>
	</tr>
	<tr rn="5" height=25 style="height:25px;">
		<td colSpan=9 id="report1_A5" colNo=1 value='一、申报抵扣的进项税额' onclick="_hideEditor()" class="report1_4">一、申报抵扣的进项税额</td>
	</tr>
	<tr rn="6" height=20 style="height:20px;">
		<td colSpan=3 id="report1_A6" colNo=1 value='栏目' onclick="_hideEditor()" class="report1_4">栏目</td>
		<td id="report1_D6" colNo=4 value='栏次' onclick="_hideEditor()" class="report1_4">栏次</td>
		<td id="report1_E6" colNo=5 value='份数' onclick="_hideEditor()" class="report1_4">份数</td>
		<td colSpan=2 id="report1_F6" colNo=6 value='金额' onclick="_hideEditor()" class="report1_4">金额</td>
		<td colSpan=2 id="report1_H6" colNo=8 value='税额' onclick="_hideEditor()" class="report1_4">税额</td>
	</tr>
	<tr rn="7" height=20 style="height:20px;">
		...
		<td id="report1_E7" colNo=5 value='0' onclick="_hideEditor()" class="report1_12">0</td>
		<td colSpan=2 id="report1_F7" colNo=6 value='135534.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">135534.00</td>
		<td colSpan=2 id="report1_H7" colNo=8 value='123213.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">123213.00</td>
	</tr>
	<tr rn="8" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F8" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='12321.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">12321.00</td>
		<td colSpan=2 id="report1_H8" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="9" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F9" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='123213.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">123213.00</td>
		<td colSpan=2 id="report1_H9" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='123213.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">123213.00</td>
	</tr>
	<tr rn="10" height=20 style="height:20px;">
		...
		<td id="report1_E10" colNo=5 value='0' onclick="_hideEditor()" class="report1_12">0</td>
		<td colSpan=2 id="report1_F10" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">0.00</td>
		<td colSpan=2 id="report1_H10" colNo=8 value='2463362.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">2463362.00</td>
	</tr>
	<tr rn="11" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F11" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H11" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="12" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F12" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H12" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='1232131.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">1232131.00</td>
	</tr>
	<tr rn="13" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F13" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H13" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='1231231.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">1231231.00</td>
	</tr>
	<tr rn="14" height=20 style="height:20px;">
		<td colSpan=3 id="report1_A14" colNo=1 value='    加计扣除农产品进项税额		 ' onclick="_hideEditor()" class="report1_11">&nbsp;&nbsp;&nbsp;&nbsp;加计扣除农产品进项税额		&nbsp;</td>
		<td id="report1_D14" colNo=4 value='8a' onclick="_hideEditor()" class="report1_11">8a</td>
		<td id="report1_E14" colNo=5 value='--' onclick="_hideEditor()" class="report1_10">--</td>
		<td colSpan=2 id="report1_F14" colNo=6 value='--' onclick="_hideEditor()" class="report1_10">--</td>
		<td colSpan=2 id="report1_H14" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="15" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F15" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H15" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="16" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F16" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H16" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="17" height=20 style="height:20px;">
		...
		<td id="report1_E17" colNo=5 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_F17" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H17" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="18" height=20 style="height:20px;">
		...
		<td id="report1_E18" colNo=5 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_F18" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H18" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="19" height=20 style="height:20px;">
		...
		<td id="report1_E19" colNo=5 value='0' onclick="_hideEditor()" class="report1_12">0</td>
		<td colSpan=2 id="report1_F19" colNo=6 value='135534.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">135534.00</td>
		<td colSpan=2 id="report1_H19" colNo=8 value='2586575.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">2586575.00</td>
	</tr>
	<tr rn="20" height=25 style="height:25px;">
		<td colSpan=9 id="report1_A20" colNo=1 value='二、进项税额转出额' onclick="_hideEditor()" class="report1_4">二、进项税额转出额</td>
	</tr>
	<tr rn="21" height=20 style="height:20px;">
		...
		<td id="report1_D21" colNo=4 value='栏次' onclick="_hideEditor()" class="report1_4">栏次</td>
		<td colSpan=5 id="report1_E21" colNo=5 value='税额' onclick="_hideEditor()" class="report1_4">税额</td>
	</tr>
	<tr rn="22" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E22" colNo=5 value='0.0' format="%230.00" digits="2" dataValid="report1_22_5_dataValid()" onclick="_hideEditor()" class="report1_13">0.00</td>
<script language=javascript>
	...
	<tr rn="23" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E23" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="24" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E24" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="25" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E25" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="26" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E26" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="27" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E27" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="28" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E28" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="29" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E29" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="30" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E30" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="31" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E31" colNo=5 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
	</tr>
	<tr rn="32" height=20 style="height:20px;">
		...
		<td colSpan=5 id="report1_E32" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="33" height=25 style="height:25px;">
		<td colSpan=9 id="report1_A33" colNo=1 value='三、待抵扣进项税额' onclick="_hideEditor()" class="report1_4">三、待抵扣进项税额</td>
	</tr>
	<tr rn="34" height=20 style="height:20px;">
		<td colSpan=3 id="report1_A34" colNo=1 value='栏目' onclick="_hideEditor()" class="report1_4">栏目</td>
		<td id="report1_D34" colNo=4 value='栏次' onclick="_hideEditor()" class="report1_4">栏次</td>
		<td id="report1_E34" colNo=5 value='份数' onclick="_hideEditor()" class="report1_4">份数</td>
		<td colSpan=2 id="report1_F34" colNo=6 value='金额' onclick="_hideEditor()" class="report1_4">金额</td>
		<td colSpan=2 id="report1_H34" colNo=8 value='税额' onclick="_hideEditor()" class="report1_4">税额</td>
	</tr>
	<tr rn="35" height=20 style="height:20px;">
		...
		<td id="report1_E35" colNo=5 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_F35" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H35" colNo=8 value='--' onclick="_hideEditor()" class="report1_9">--</td>
	</tr>
	<tr rn="36" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F36" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H36" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="37" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F37" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H37" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="38" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F38" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H38" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="39" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F39" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H39" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="40" height=20 style="height:20px;">
		...
		<td id="report1_E40" colNo=5 value='0' onclick="_hideEditor()" class="report1_12">0</td>
		<td colSpan=2 id="report1_F40" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">0.00</td>
		<td colSpan=2 id="report1_H40" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_13">0.00</td>
	</tr>
	<tr rn="41" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F41" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H41" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="42" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F42" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H42" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="43" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F43" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H43" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="44" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F44" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H44" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="45" height=20 style="height:20px;">
		...
		<td id="report1_E45" colNo=5 value='0' onclick="_hideEditor()" class="report1_7">0</td>
		<td colSpan=2 id="report1_F45" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td colSpan=2 id="report1_H45" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
	</tr>
	<tr rn="46" height=25 style="height:25px;">
		<td colSpan=9 id="report1_A46" colNo=1 value='四、其他' onclick="_hideEditor()" class="report1_4">四、其他</td>
	</tr>
	<tr rn="47" height=20 style="height:20px;">
		<td colSpan=3 id="report1_A47" colNo=1 value='栏目' onclick="_hideEditor()" class="report1_4">栏目</td>
		<td id="report1_D47" colNo=4 value='栏次' onclick="_hideEditor()" class="report1_4">栏次</td>
		<td id="report1_E47" colNo=5 value='份数' onclick="_hideEditor()" class="report1_4">份数</td>
		<td colSpan=2 id="report1_F47" colNo=6 value='金额' onclick="_hideEditor()" class="report1_4">金额</td>
		<td colSpan=2 id="report1_H47" colNo=8 value='税额' onclick="_hideEditor()" class="report1_4">税额</td>
	</tr>
	<tr rn="48" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_F48" colNo=6 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
		<td colSpan=2 id="report1_H48" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
	<tr rn="49" height=20 style="height:20px;">
		...
		<td id="report1_E49" colNo=5 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_F49" colNo=6 value='--' onclick="_hideEditor()" class="report1_9">--</td>
		<td colSpan=2 id="report1_H49" colNo=8 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_6">0.00</td>
	</tr>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_11336">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showReport.jsp?raq=%2Fzzs2013Ybnsr%2FybnsrFb2.raq&nsrsbh=450100399111430&sbzt=0&skssq=20171111&ssqq=2017-11-01&ssqz=2017-11-30&isTbBz=0&reportParamsId=15127051901069570111065">
