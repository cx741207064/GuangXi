<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showReport_ybnsrFb5.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showReport_ybnsrFb5" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_41505";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&columns=0&srcType=file&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&columns=0&srcType=file&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&srcType=file&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=15123563587575313140641&cachedId=10_1_1_176_8080_41505&t_i_m_e=1512356359053";
	}
</script>
...
<style id="report1_style">
	...
	.report1_4 { text-align:center;vertical-align:middle;font-family:Dialog;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
	...
	.report1_7 { text-align:center;vertical-align:middle;font-family:宋体;font-size:16px;color:#000000;font-weight:bold;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:none;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
	...
	.report1_10 { text-align:center;vertical-align:middle;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
</style>
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1457162out()" onmouseover="report1457162over()" rowCount=7 cols=6 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:837px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=30 style="height:30px;">
		<td colSpan=6 id="report1_A1" colNo=1 value='增值税纳税申报表附列资料（五）' onclick="_hideEditor()" class="report1_7">增值税纳税申报表附列资料（五）</td>
	</tr>
	<tr rn="2" height=20 style="height:20px;">
		<td colSpan=6 id="report1_A2" colNo=1 value='（不动产分期抵扣计算表）' onclick="_hideEditor()" class="report1_10">（不动产分期抵扣计算表）</td>
	</tr>
	<tr rn="3" height=22 style="height:22px;">
		<td id="report1_A3" colNo=1 value='纳税人识别号：' onclick="_hideEditor()" class="report1_9">纳税人识别号：</td>
		<td id="report1_B3" colNo=2 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td id="report1_C3" colNo=3 value='填表日期： ' onclick="_hideEditor()" class="report1_6">填表日期：&nbsp;</td>
		<td id="report1_D3" colNo=4 value='' onclick="_hideEditor()" class="report1_6"></td>
		<td colSpan=2 id="report1_E3" colNo=5 value='金额单位:元至角分' onclick="_hideEditor()" class="report1_6">金额单位:元至角分</td>
	</tr>
	<tr rn="4" height=31 style="height:31px;">
		<td id="report1_A4" colNo=1 value='纳税人名称：' onclick="_hideEditor()" class="report1_9">纳税人名称：</td>
		<td id="report1_B4" colNo=2 value='' onclick="_hideEditor()" class="report1_3"></td>
		<td id="report1_C4" colNo=3 value='所属时期： ' onclick="_hideEditor()" class="report1_2">所属时期：&nbsp;</td>
		<td id="report1_D4" colNo=4 value='' onclick="_hideEditor()" class="report1_6"></td>
		<td id="report1_E4" colNo=5 value='至' onclick="_hideEditor()" class="report1_6">至</td>
		<td id="report1_F4" colNo=6 value='' onclick="_hideEditor()" class="report1_6"></td>
	</tr>
	<tr rn="5" height=38 style="height:38px;">
		<td id="report1_A5" colNo=1 value='期初待抵扣不动产进项税额' onclick="_hideEditor()" class="report1_2">期初待抵扣不动产进<br>项税额</td>
		<td id="report1_B5" colNo=2 value='本期不动产进项税额增加额' onclick="_hideEditor()" class="report1_2">本期不动产进项税额增加额</td>
		<td id="report1_C5" colNo=3 value='本期可抵扣不动产进项税额' onclick="_hideEditor()" class="report1_2">本期可抵扣不动产进项税<br>额</td>
		<td id="report1_D5" colNo=4 value='本期转入的待抵扣不动产进项税额' onclick="_hideEditor()" class="report1_2">本期转入的待抵扣不动<br>产进项税额</td>
		<td id="report1_E5" colNo=5 value='本期转出的待抵扣不动产进项税额' onclick="_hideEditor()" class="report1_2">本期转出的待抵扣不<br>动产进项税额</td>
		<td id="report1_F5" colNo=6 value='期末待抵扣不动产进项税额' onclick="_hideEditor()" class="report1_2">期末待抵扣不动产进<br>项税额</td>
	</tr>
	<tr rn="6" height=23 style="height:23px;">
		<td id="report1_A6" colNo=1 value='1' onclick="_hideEditor()" class="report1_4">1</td>
		<td id="report1_B6" colNo=2 value='2' onclick="_hideEditor()" class="report1_4">2</td>
		<td id="report1_C6" colNo=3 value='3≤1+2+4' onclick="_hideEditor()" class="report1_4">3≤1+2+4</td>
		<td id="report1_D6" colNo=4 value='4' onclick="_hideEditor()" class="report1_4">4</td>
		<td id="report1_E6" colNo=5 value='5≤1+4' onclick="_hideEditor()" class="report1_4">5≤1+4</td>
		<td id="report1_F6" colNo=6 value='6=1+2-3+4-5' onclick="_hideEditor()" class="report1_4">6=1+2-3+4-5</td>
	</tr>
	<tr rn="7" height=23 style="height:23px;">
		...
		<td id="report1_B7" colNo=2 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_5">0.00</td>
		...
		<td id="report1_E7" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_5">0.00</td>
		<td id="report1_F7" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_8">0.00</td>
	</tr>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_41505">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showReport.jsp?raq=%2Fzzs2013Ybnsr%2FybnsrFb5.raq&nsrsbh=450100399111430&sbzt=0&skssq=20171111&ssqq=2017-11-01&ssqz=2017-11-30&isTbBz=0&reportParamsId=15123563587575313140641">
