<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showCxReport_ybnsrFb3.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showCxReport_ybnsrFb3" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_73507";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=1511490543995769171015&cachedId=10_1_1_176_8080_73507&t_i_m_e=1511490544011";
	}
</script>
...
<style id="report1_style">
	...
	.report1_2 { text-align:center;vertical-align:middle;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;line-height:16px;}
	...
	.report1_9 { text-align:center;vertical-align:top;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;line-height:16px;}
	.report1_10 { text-align:center;vertical-align:bottom;font-family:宋体;font-size:18px;color:#000000;font-weight:bold;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:none;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
</style>
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1487535out()" onmouseover="report1487535over()" rowCount=15 cols=8 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:870px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=40 style="height:40px;">
		<td colSpan=8 id="report1_A1" colNo=1 value='10014517000033386709' onclick="_hideEditor()" class="report1_10">增值税纳税申报表附列资料（三）</td>
	</tr>
	<tr rn="2" height=28 style="height:28px;">
		<td colSpan=8 id="report1_A2" colNo=1 value='（服务、不动产和无形资产扣除项目明细）' onclick="_hideEditor()" class="report1_9">（服务、不动产和无形资产扣除项目明细）</td>
	</tr>
	<tr rn="3" height=20 style="height:20px;">
		<td id="report1_A3" colNo=1 value='纳税人识别号：' onclick="_hideEditor()" class="report1_8">纳税人识别号：</td>
		<td colSpan=3 id="report1_B3" colNo=2 value='91450107MA5KE0EQ2B' onclick="_hideEditor()" class="report1_6">91450107MA5KE0EQ2B</td>
		<td id="report1_E3" colNo=5 value='填表日期：' onclick="_hideEditor()" class="report1_2">填表日期：</td>
		<td id="report1_F3" colNo=6 value='2017-11-02' onclick="_hideEditor()" class="report1_2">2017-11-02</td>
		<td colSpan=2 id="report1_G3" colNo=7 value='金额单位：元（列至角分）' onclick="_hideEditor()" class="report1_2">金额单位：元（列至角分）</td>
	</tr>
	<tr rn="4" height=35 style="height:35px;">
		<td id="report1_A4" colNo=1 value='纳税人名称：' onclick="_hideEditor()" class="report1_8">纳税人名称：</td>
		<td colSpan=3 id="report1_B4" colNo=2 value='广西龙森胜贸易有限公司' onclick="_hideEditor()" class="report1_6">广西龙森胜贸易有限公司</td>
		<td id="report1_E4" colNo=5 value='所属时期：' onclick="_hideEditor()" class="report1_2">所属时期：</td>
		<td id="report1_F4" colNo=6 value='2017-10-01' onclick="_hideEditor()" class="report1_2">2017-10-01</td>
		<td id="report1_G4" colNo=7 value='至' onclick="_hideEditor()" class="report1_2">至</td>
		<td id="report1_H4" colNo=8 value='2017-10-31' onclick="_hideEditor()" class="report1_2">2017-10-31</td>
	</tr>
	<tr rn="5" height=26 style="height:26px;">
		<td rowSpan=3 colSpan=2 id="report1_A5" colNo=1 value='项目及栏次' onclick="_hideEditor()" class="report1_2">项目及栏次</td>
		<td rowSpan=2 id="report1_C5" colNo=3 value='本期服务、不动产和无形资产价税合计额（免税销售额）' onclick="_hideEditor()" class="report1_2">本期服务、不动产和无<br>形资产价税合计额（免<br>税销售额）</td>
		<td colSpan=5 id="report1_D5" colNo=4 value='服务、不动产和无形资产扣除项目' onclick="_hideEditor()" class="report1_2">服务、不动产和无形资产扣除项目</td>
	</tr>
	<tr rn="6" height=26 style="height:26px;">
		<td id="report1_D6" colNo=4 value='期初余额' onclick="_hideEditor()" class="report1_2">期初余额</td>
		<td id="report1_E6" colNo=5 value='本期发生额' onclick="_hideEditor()" class="report1_2">本期发生额</td>
		<td id="report1_F6" colNo=6 value='本期应扣除金额' onclick="_hideEditor()" class="report1_2">本期应扣除金额</td>
		<td id="report1_G6" colNo=7 value='本期实际扣除金额' onclick="_hideEditor()" class="report1_2">本期实际扣除金额</td>
		<td id="report1_H6" colNo=8 value='期末余额' onclick="_hideEditor()" class="report1_2">期末余额</td>
	</tr>
	<tr rn="7" height=20 style="height:20px;">
		<td id="report1_C7" colNo=3 value='1' onclick="_hideEditor()" class="report1_2">1</td>
		<td id="report1_D7" colNo=4 value='2' onclick="_hideEditor()" class="report1_2">2</td>
		<td id="report1_E7" colNo=5 value='3' onclick="_hideEditor()" class="report1_2">3</td>
		<td id="report1_F7" colNo=6 value='4=2+3' onclick="_hideEditor()" class="report1_2">4=2+3</td>
		<td id="report1_G7" colNo=7 value='5(5≤1 且 5≤4)' onclick="_hideEditor()" class="report1_2">5(5≤1&nbsp;且&nbsp;5≤4)</td>
		<td id="report1_H7" colNo=8 value='6=4-5' onclick="_hideEditor()" class="report1_2">6=4-5</td>
	</tr>
	<tr rn="8" height=20 style="height:20px;">
		<td id="report1_A8" colNo=1 value='17%税率的项目' onclick="_hideEditor()" class="report1_1">17%税率的项目</td>
	...
	<tr rn="9" height=20 style="height:20px;">
		<td id="report1_A9" colNo=1 value='11%税率的项目' onclick="_hideEditor()" class="report1_1">11%税率的项目</td>
		...
		<td id="report1_F9" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		...
		<td id="report1_H9" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="10" height=34 style="height:34px;">
		<td id="report1_A10" colNo=1 value='6%税率的项目（不含金融商品转让）' onclick="_hideEditor()" class="report1_1">6%税率的项目（不含金融商<br>品转让）</td>
		...
		<td id="report1_F10" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		...
		<td id="report1_H10" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="11" height=20 style="height:20px;">
		<td id="report1_A11" colNo=1 value='6%税率的金融商品转让项目' onclick="_hideEditor()" class="report1_1">6%税率的金融商品转让项目</td>
	...
	<tr rn="13" height=20 style="height:20px;">
		<td id="report1_A13" colNo=1 value='3%征收率的项目' onclick="_hideEditor()" class="report1_1">3%征收率的项目</td>
	...
	<tr rn="14" height=20 style="height:20px;">
		<td id="report1_A14" colNo=1 value='免抵退税的项目' onclick="_hideEditor()" class="report1_1">免抵退税的项目</td>
	...
	<tr rn="15" height=20 style="height:20px;">
		<td id="report1_A15" colNo=1 value='免税的项目' onclick="_hideEditor()" class="report1_1">免税的项目</td>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_73507">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showCxReport.jsp?raq=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&nsrsbh=91450107MA5KE0EQ2B&isTbBz=1&dataFromBz=0&pzxh=10014517000033386709&sbuuid=F0A486ECC12ABC478BE0031BF355F0AD&reportParamsId=1511490543995769171015">
	...
	<input type=hidden name=params value="bbmc=WBJK_SB_ZZS_2013_FB3;xmlName=zzs2013/zzs_ybnsr_fb3;pzxh=10014517000033386709;nsrsbh=91450107MA5KE0EQ2B;dataFromBz=0;raq=/zzs2013Ybnsr/ybnsrFb3.raq;sbuuid=F0A486ECC12ABC478BE0031BF355F0AD;isTbBz=1">
...
<script language=javascript>
	function report1_importExcel() {
		var address = "/WSSBSL/reportServlet?action=17&fileName=/zzs2013Ybnsr/ybnsrFb3.raq&srcType=file&cachedId=10_1_1_176_8080_73507&isScroll=0&backAndRefresh=yes&webTableName=report1&canSelectSheet=no&params=bbmc%3DWBJK_SB_ZZS_2013_FB3%3BxmlName%3Dzzs2013%2Fzzs_ybnsr_fb3%3Bpzxh%3D10014517000033386709%3Bnsrsbh%3D91450107MA5KE0EQ2B%3BdataFromBz%3D0%3Braq%3D%2Fzzs2013Ybnsr%2FybnsrFb3.raq%3Bsbuuid%3DF0A486ECC12ABC478BE0031BF355F0AD%3BisTbBz%3D1&inputListener=cn.gxgs.bsblt.wssb.wssbsl.report.action.RQReportAction&canImport2DB=1";
