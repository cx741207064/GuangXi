<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showReport_bqdkjxsejgmxb.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showReport_bqdkjxsejgmxb" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_45880";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&columns=0&srcType=file&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&columns=0&srcType=file&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&srcType=file&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=15123641993302793144898&cachedId=10_1_1_176_8080_45880&t_i_m_e=1512364199346";
	}
</script>
...
<style id="report1_style">
	...
	.report1_6 { text-align:left;vertical-align:middle;font-family:宋体;font-size:12px;color:#0000FF;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#E1E1E1;white-space:nowrap;overflow:hidden;word-break:keep-all;}
	...
	.report1_9 { text-align:right;vertical-align:middle;font-family:宋体;font-size:12px;color:#009900;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:solid;border-left-width:1px;border-left-color:#000000;border-top-style:solid;border-top-width:1px;border-top-color:#000000;border-right-style:solid;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#E1E1E1;white-space:nowrap;overflow:hidden;word-break:keep-all;}
...
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1461414out()" onmouseover="report1461414over()" rowCount=38 cols=7 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:606px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=48 style="height:48px;">
		<td colSpan=7 id="report1_A1" colNo=1 value='本期抵扣进项税额结构明细表' onclick="_hideEditor()" class="report1_10">本期抵扣进项税额结构明细表</td>
	</tr>
	<tr rn="2" height=33 style="height:33px;">
		<td id="report1_A2" colNo=1 value='纳税人识别号：' onclick="_hideEditor()" class="report1_8">纳税人识别号：</td>
		<td colSpan=2 id="report1_B2" colNo=2 value='' onclick="_hideEditor()" class="report1_2"></td>
		<td id="report1_D2" colNo=4 value='填表日期： ' onclick="_hideEditor()" class="report1_1">填表日期：&nbsp;</td>
		<td id="report1_E2" colNo=5 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td colSpan=2 id="report1_F2" colNo=6 value='金额单位:元至角分' onclick="_hideEditor()" class="report1_1">金额单位:元至角分</td>
	</tr>
	<tr rn="3" height=40 style="height:40px;">
		<td id="report1_A3" colNo=1 value='纳税人名称：' onclick="_hideEditor()" class="report1_8">纳税人名称：</td>
		<td colSpan=2 id="report1_B3" colNo=2 value='' onclick="_hideEditor()" class="report1_2"></td>
		<td id="report1_D3" colNo=4 value='所属时期： ' onclick="_hideEditor()" class="report1_1">所属时期：&nbsp;</td>
		<td id="report1_E3" colNo=5 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td id="report1_F3" colNo=6 value='至 ' onclick="_hideEditor()" class="report1_1">至&nbsp;</td>
		<td id="report1_G3" colNo=7 value='' onclick="_hideEditor()" class="report1_1"></td>
	</tr>
	<tr rn="4" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A4" colNo=1 value='' onclick="_hideEditor()" class="report1_1"></td>
		<td id="report1_C4" colNo=3 value='栏次' onclick="_hideEditor()" class="report1_1">栏次</td>
		<td colSpan=2 id="report1_D4" colNo=4 value='金额' onclick="_hideEditor()" class="report1_1">金额</td>
		<td colSpan=2 id="report1_F4" colNo=6 value='税额' onclick="_hideEditor()" class="report1_1">税额</td>
	</tr>
	<tr rn="5" height=53 style="height:53px;">
		<td colSpan=2 id="report1_A5" colNo=1 value='合计' onclick="_hideEditor()" class="report1_1">合计</td>
		...
		<td colSpan=2 id="report1_D5" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_9">0.00</td>
		<td colSpan=2 id="report1_F5" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_9">0.00</td>
	</tr>
	...
	<tr rn="7" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A7" colNo=1 value='17%税率的进项' onclick="_hideEditor()" class="report1_1">17%税率的进项</td>
		<td id="report1_C7" colNo=3 value='2' onclick="_hideEditor()" class="report1_2">2</td>
		<td colSpan=2 id="report1_D7" colNo=4 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_3">0.00</td>
	...
	<tr rn="8" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A8" colNo=1 value='   其中：有形动产租赁的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;其中：有形动产租赁的进项</td>
		<td id="report1_C8" colNo=3 value='3' onclick="_hideEditor()" class="report1_2">3</td>
		<td colSpan=2 id="report1_D8" colNo=4 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_3">0.00</td>
	...
	<tr rn="9" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A9" colNo=1 value='13%税率的进项' onclick="_hideEditor()" class="report1_1">13%税率的进项</td>
		<td id="report1_C9" colNo=3 value='4' onclick="_hideEditor()" class="report1_2">4</td>
		<td colSpan=2 id="report1_D9" colNo=4 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_3">0.00</td>
	...
	<tr rn="10" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A10" colNo=1 value='11%税率的进项' onclick="_hideEditor()" class="report1_1">11%税率的进项</td>
		<td id="report1_C10" colNo=3 value='5' onclick="_hideEditor()" class="report1_2">5</td>
		<td colSpan=2 id="report1_D10" colNo=4 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_3">0.00</td>
	...
	<tr rn="11" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A11" colNo=1 value='      其中：运输服务的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其中：运输服务的进项</td>
	...
	<tr rn="12" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A12" colNo=1 value='电信服务的进项' onclick="_hideEditor()" class="report1_1">电信服务的进项</td>
		<td id="report1_C12" colNo=3 value='7' onclick="_hideEditor()" class="report1_5">7</td>
	...
	<tr rn="13" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A13" colNo=1 value='    建筑安装服务的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;&nbsp;建筑安装服务的进项</td>
	...
	<tr rn="14" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A14" colNo=1 value='      不动产租赁服务的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;不动产租赁服务的进项</td>
	...
	<tr rn="15" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A15" colNo=1 value='       受让土地使用权的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;受让土地使用权的进项</td>
	...
	<tr rn="16" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A16" colNo=1 value='6%税率的进项' onclick="_hideEditor()" class="report1_1">6%税率的进项</td>
	...
	<tr rn="17" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A17" colNo=1 value='     其中：电信服务的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其中：电信服务的进项</td>
	...
	<tr rn="18" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A18" colNo=1 value='            金融保险服务的进项' onclick="_hideEditor()" class="report1_5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金融保险服务的进项</td>
	...
	<tr rn="19" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A19" colNo=1 value='生活服务的进项' onclick="_hideEditor()" class="report1_1">生活服务的进项</td>
		<td id="report1_C19" colNo=3 value='14' onclick="_hideEditor()" class="report1_5">14</td>
	...
	<tr rn="20" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A20" colNo=1 value='   取得无形资产的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;取得无形资产的进项</td>
		<td id="report1_C20" colNo=3 value='15' onclick="_hideEditor()" class="report1_5">15</td>
	...
	<tr rn="21" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A21" colNo=1 value='5%征收率的进项' onclick="_hideEditor()" class="report1_1">5%征收率的进项</td>
	...
	<tr rn="22" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A22" colNo=1 value='   其中：不动产租赁服务的进项' onclick="_hideEditor()" class="report1_1">&nbsp;&nbsp;&nbsp;其中：不动产租赁服务的进项</td>
	...
	<tr rn="23" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A23" colNo=1 value='3%征收率的进项' onclick="_hideEditor()" class="report1_1">3%征收率的进项</td>
	...
	<tr rn="24" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A24" colNo=1 value='其中：货物及加工、修理修配劳务的进项' onclick="_hideEditor()" class="report1_1">其中：货物及加工、修理修配劳务的进项</td>
		<td id="report1_C24" colNo=3 value='19' onclick="_hideEditor()" class="report1_5">19</td>
	...
	<tr rn="25" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A25" colNo=1 value='运输服务的进项' onclick="_hideEditor()" class="report1_1">运输服务的进项</td>
		<td id="report1_C25" colNo=3 value='20' onclick="_hideEditor()" class="report1_5">20</td>
	...
	<tr rn="26" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A26" colNo=1 value='电信服务的进项' onclick="_hideEditor()" class="report1_1">电信服务的进项</td>
		<td id="report1_C26" colNo=3 value='21' onclick="_hideEditor()" class="report1_5">21</td>
	...
	<tr rn="27" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A27" colNo=1 value='建筑安装服务的进项' onclick="_hideEditor()" class="report1_1">建筑安装服务的进项</td>
		<td id="report1_C27" colNo=3 value='22' onclick="_hideEditor()" class="report1_5">22</td>
	...
	<tr rn="28" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A28" colNo=1 value='金融保险服务的进项' onclick="_hideEditor()" class="report1_1">金融保险服务的进项</td>
		<td id="report1_C28" colNo=3 value='23' onclick="_hideEditor()" class="report1_5">23</td>
	...
	<tr rn="29" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A29" colNo=1 value='有形动产租赁服务的进项' onclick="_hideEditor()" class="report1_1">有形动产租赁服务的进项</td>
		<td id="report1_C29" colNo=3 value='24' onclick="_hideEditor()" class="report1_5">24</td>
	...
	<tr rn="30" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A30" colNo=1 value='生活服务的进项' onclick="_hideEditor()" class="report1_1">生活服务的进项</td>
		<td id="report1_C30" colNo=3 value='25' onclick="_hideEditor()" class="report1_5">25</td>
	...
	<tr rn="31" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A31" colNo=1 value='取得无形资产的进项' onclick="_hideEditor()" class="report1_1">取得无形资产的进项</td>
	...
	<tr rn="32" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A32" colNo=1 value='减按1.5%征收率的进项' onclick="_hideEditor()" class="report1_1">减按1.5%征收率的进项</td>
	...
	<tr rn="33" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A33" colNo=1 value='' onclick="_hideEditor()" class="report1_5"></td>
		<td id="report1_C33" colNo=3 value='28' onclick="_hideEditor()" class="report1_5">28</td>
		<td colSpan=2 id="report1_D33" colNo=4 value='' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_6"></td>
		<td colSpan=2 id="report1_F33" colNo=6 value='' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_6"></td>
	</tr>
	...
	<tr rn="35" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A35" colNo=1 value='用于构建不动产并一次性抵扣的进项' onclick="_hideEditor()" class="report1_1">用于构建不动产并一次性抵扣的进项</td>
	...
	<tr rn="36" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A36" colNo=1 value='通行费的进项' onclick="_hideEditor()" class="report1_1">通行费的进项</td>
		<td id="report1_C36" colNo=3 value='30' onclick="_hideEditor()" class="report1_5">30</td>
	...
	<tr rn="37" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A37" colNo=1 value='' onclick="_hideEditor()" class="report1_5"></td>
		<td id="report1_C37" colNo=3 value='31' onclick="_hideEditor()" class="report1_5">31</td>
		<td colSpan=2 id="report1_D37" colNo=4 value='' onclick="_hideEditor()" class="report1_6"></td>
		<td colSpan=2 id="report1_F37" colNo=6 value='' onclick="_hideEditor()" class="report1_6"></td>
	</tr>
	<tr rn="38" height=23 style="height:23px;">
		<td colSpan=2 id="report1_A38" colNo=1 value='' onclick="_hideEditor()" class="report1_5"></td>
		<td id="report1_C38" colNo=3 value='32' onclick="_hideEditor()" class="report1_2">32</td>
		<td colSpan=2 id="report1_D38" colNo=4 value='' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_6"></td>
		<td colSpan=2 id="report1_F38" colNo=6 value='' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_6"></td>
	</tr>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_45880">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showReport.jsp?raq=%2Fzzs2013Ybnsr%2Fbqdkjxsejgmxb.raq&nsrsbh=450100399111430&sbzt=0&skssq=20171111&ssqq=2017-11-01&ssqz=2017-11-30&isTbBz=0&reportParamsId=15123641993302793144898">
