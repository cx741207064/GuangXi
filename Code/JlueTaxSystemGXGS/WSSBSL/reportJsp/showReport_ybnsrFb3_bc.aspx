<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showReport_ybnsrFb3_bc.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showReport_ybnsrFb3_bc" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_11393";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&columns=0&srcType=file&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=15127052896806662111111&cachedId=10_1_1_176_8080_11393&t_i_m_e=1512705290085";
	}
</script>
...
<style id="report1_style">
	...
	.report1_9 { text-align:center;vertical-align:bottom;font-family:宋体;font-size:18px;color:#000000;font-weight:bold;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:none;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
	.report1_10 { text-align:center;vertical-align:top;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;line-height:16px;}
</style>
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1427632out()" onmouseover="report1427632over()" rowCount=15 cols=8 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:870px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=40 style="height:40px;">
		<td colSpan=8 id="report1_A1" colNo=1 value='46505561' onclick="_hideEditor()" class="report1_9">增值税纳税申报表附列资料（三）</td>
	</tr>
	<tr rn="2" height=28 style="height:28px;">
		<td colSpan=8 id="report1_A2" colNo=1 value='（服务、不动产和无形资产扣除项目明细）' onclick="_hideEditor()" class="report1_10">（服务、不动产和无形资产扣除项目明细）</td>
	</tr>
	<tr rn="3" height=20 style="height:20px;">
		<td id="report1_A3" colNo=1 value='纳税人识别号：' onclick="_hideEditor()" class="report1_8">纳税人识别号：</td>
		<td colSpan=3 id="report1_B3" colNo=2 value='' onclick="_hideEditor()" class="report1_6"></td>
		...
		<td colSpan=2 id="report1_G3" colNo=7 value='金额单位：元（列至角分）' onclick="_hideEditor()" class="report1_3">金额单位：元（列至角分）</td>
	</tr>
	<tr rn="4" height=35 style="height:35px;">
		<td id="report1_A4" colNo=1 value='纳税人名称：' onclick="_hideEditor()" class="report1_8">纳税人名称：</td>
		<td colSpan=3 id="report1_B4" colNo=2 value='' onclick="_hideEditor()" class="report1_6"></td>
	...
	<tr rn="5" height=26 style="height:26px;">
		<td rowSpan=3 colSpan=2 id="report1_A5" colNo=1 value='项目及栏次' onclick="_hideEditor()" class="report1_3">项目及栏次</td>
		<td rowSpan=2 id="report1_C5" colNo=3 value='本期服务、不动产和无形资产价税合计额（免税销售额）' onclick="_hideEditor()" class="report1_3">本期服务、不动产和无<br>形资产价税合计额（免<br>税销售额）</td>
		<td colSpan=5 id="report1_D5" colNo=4 value='服务、不动产和无形资产扣除项目' onclick="_hideEditor()" class="report1_3">服务、不动产和无形资产扣除项目</td>
	</tr>
	<tr rn="6" height=26 style="height:26px;">
		<td id="report1_D6" colNo=4 value='期初余额' onclick="_hideEditor()" class="report1_3">期初余额</td>
		<td id="report1_E6" colNo=5 value='本期发生额' onclick="_hideEditor()" class="report1_3">本期发生额</td>
		<td id="report1_F6" colNo=6 value='本期应扣除金额' onclick="_hideEditor()" class="report1_3">本期应扣除金额</td>
		<td id="report1_G6" colNo=7 value='本期实际扣除金额' onclick="_hideEditor()" class="report1_3">本期实际扣除金额</td>
		<td id="report1_H6" colNo=8 value='期末余额' onclick="_hideEditor()" class="report1_3">期末余额</td>
	</tr>
	<tr rn="7" height=20 style="height:20px;">
		<td id="report1_C7" colNo=3 value='1' onclick="_hideEditor()" class="report1_3">1</td>
		<td id="report1_D7" colNo=4 value='2' onclick="_hideEditor()" class="report1_3">2</td>
		<td id="report1_E7" colNo=5 value='3' onclick="_hideEditor()" class="report1_3">3</td>
		<td id="report1_F7" colNo=6 value='4=2+3' onclick="_hideEditor()" class="report1_3">4=2+3</td>
		<td id="report1_G7" colNo=7 value='5(5≤1 且 5≤4)' onclick="_hideEditor()" class="report1_3">5(5≤1&nbsp;且&nbsp;5≤4)</td>
		<td id="report1_H7" colNo=8 value='6=4-5' onclick="_hideEditor()" class="report1_3">6=4-5</td>
	</tr>
	<tr rn="8" height=20 style="height:20px;">
		<td id="report1_A8" colNo=1 value='17%税率的项目' onclick="_hideEditor()" class="report1_2">17%税率的项目</td>
		<td id="report1_B8" colNo=2 value='1' onclick="_hideEditor()" class="report1_5">1</td>
		<td id="report1_C8" colNo=3 modifiable=true writable=true editStyle="1" inputDataType="2" value='123213.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">123213.00</td>
		<td id="report1_D8" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		<td id="report1_E8" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='2.1321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">21321321.00</td>
		<td id="report1_F8" colNo=6 value='2.1321321E7' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">21321321.00</td>
		<td id="report1_G8" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='1.2321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">12321321.00</td>
		<td id="report1_H8" colNo=8 value='9000000.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">9000000.00</td>
	</tr>
	<tr rn="9" height=20 style="height:20px;">
		<td id="report1_A9" colNo=1 value='11%税率的项目' onclick="_hideEditor()" class="report1_2">11%税率的项目</td>
		<td id="report1_B9" colNo=2 value='2' onclick="_hideEditor()" class="report1_5">2</td>
		<td id="report1_C9" colNo=3 modifiable=true writable=true editStyle="1" inputDataType="2" value='2.1321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">21321321.00</td>
		<td id="report1_D9" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		<td id="report1_E9" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='1.2321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">12321321.00</td>
		<td id="report1_F9" colNo=6 value='1.2321321E7' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">12321321.00</td>
		...
		<td id="report1_H9" colNo=8 value='1.2321321E7' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">12321321.00</td>
	</tr>
	<tr rn="10" height=34 style="height:34px;">
		<td id="report1_A10" colNo=1 value='6%税率的项目（不含金融商品转让）' onclick="_hideEditor()" class="report1_2">6%税率的项目（不含金融商<br>品转让）</td>
		<td id="report1_B10" colNo=2 value='3' onclick="_hideEditor()" class="report1_5">3</td>
		<td id="report1_C10" colNo=3 modifiable=true writable=true editStyle="1" inputDataType="2" value='1.2321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">12321321.00</td>
		<td id="report1_D10" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		<td id="report1_E10" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='1.2321321E7' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">12321321.00</td>
		<td id="report1_F10" colNo=6 value='1.2321321E7' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">12321321.00</td>
		...
		<td id="report1_H10" colNo=8 value='1.2321321E7' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">12321321.00</td>
	</tr>
	<tr rn="11" height=20 style="height:20px;">
		<td id="report1_A11" colNo=1 value='6%税率的金融商品转让项目' onclick="_hideEditor()" class="report1_2">6%税率的金融商品转让项目</td>
		<td id="report1_B11" colNo=2 value='4' onclick="_hideEditor()" class="report1_5">4</td>
		...
		<td id="report1_D11" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		...
		<td id="report1_F11" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		...
		<td id="report1_H11" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="12" height=20 style="height:20px;">
		<td id="report1_A12" colNo=1 value='5%征收率的项目' onclick="_hideEditor()" class="report1_6">5%征收率的项目</td>
		<td id="report1_B12" colNo=2 value='5' onclick="_hideEditor()" class="report1_5">5</td>
		...
		<td id="report1_D12" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		...
		<td id="report1_F12" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		...
		<td id="report1_H12" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="13" height=20 style="height:20px;">
		<td id="report1_A13" colNo=1 value='3%征收率的项目' onclick="_hideEditor()" class="report1_2">3%征收率的项目</td>
		<td id="report1_B13" colNo=2 value='6' onclick="_hideEditor()" class="report1_5">6</td>
		...
		<td id="report1_D13" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		...
		<td id="report1_F13" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		...
		<td id="report1_H13" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="14" height=20 style="height:20px;">
		<td id="report1_A14" colNo=1 value='免抵退税的项目' onclick="_hideEditor()" class="report1_2">免抵退税的项目</td>
		<td id="report1_B14" colNo=2 value='7' onclick="_hideEditor()" class="report1_5">7</td>
		...
		<td id="report1_D14" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		<td id="report1_E14" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">0.00</td>
		<td id="report1_F14" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		<td id="report1_G14" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">0.00</td>
		<td id="report1_H14" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
	<tr rn="15" height=20 style="height:20px;">
		<td id="report1_A15" colNo=1 value='免税的项目' onclick="_hideEditor()" class="report1_2">免税的项目</td>
		<td id="report1_B15" colNo=2 value='8' onclick="_hideEditor()" class="report1_5">8</td>
		...
		<td id="report1_D15" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_7">0.00</td>
		...
		<td id="report1_F15" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
		<td id="report1_G15" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_1">0.00</td>
		<td id="report1_H15" colNo=8 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_4">0.00</td>
	</tr>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_11393">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showReport.jsp?raq=%2Fzzs2013Ybnsr%2FybnsrFb3.raq&nsrsbh=450100399111430&sbzt=0&skssq=20171111&ssqq=2017-11-01&ssqz=2017-11-30&isTbBz=0&reportParamsId=15127052896806662111111">
