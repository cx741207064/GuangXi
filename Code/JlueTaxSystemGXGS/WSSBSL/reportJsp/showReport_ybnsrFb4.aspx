<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="showReport_ybnsrFb4.aspx.cs" Inherits="JlueTaxSystemGXGS.WSSBSL.reportJsp.showReport_ybnsrFb4" %>
...
<script language=javascript>
	...
	var report1_cachedId = "10_1_1_176_8080_41504";
</script>
<script language=javascript>
	...
	function report1_saveAsExcel2( returnVal) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=3&file=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&columns=0&srcType=file&width=0&height=0&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022" + returnVal;
	}
</script>
<script language=javascript>
	...
	function report1_saveAsPdf2( returnVal ) {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=6&file=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&columns=0&srcType=file&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022" + returnVal;
	}
</script>

<script language=javascript>
	function report1_saveAsWord() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=7&file=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&columns=0&srcType=file&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022";
	}
</script>
...
<script language=javascript>
	function report1_saveAsText() {
		document.report1_saveAs_frame.location = "/WSSBSL/reportServlet?action=18&file=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&srcType=file&separator=%09&lineBreak=%0A&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022";
	}
</script>

<script language=javascript>
	function report1_pivot() {
		window.open( "/WSSBSL/reportServlet?action=28&file=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&srcType=file&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022" );
	}
</script>

<script language=javascript>
	function report1_print() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=2&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&serverPagedPrint=no&mirror=no&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022";
	}
</script>
...
<script language=javascript>
	function report1_directPrint() {
		document.report1_printIFrame.location = "/WSSBSL/reportServlet?action=30&name=report1&reportFileName=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&srcType=file&savePrintSetup=no&appletJarName=runqianReport4Applet.jar%2CdmGraphApplet.jar&needPrintPrompt=no&needSelectPrinter=no&mirror=no&reportParamsId=15123563587574147140642&cachedId=10_1_1_176_8080_41504&t_i_m_e=1512356359022";
	}
</script>
...
<style id="report1_style">
	...
	.report1_8 { text-align:center;vertical-align:top;font-family:宋体;font-size:12px;color:#000000;font-weight:normal;font-style:normal;text-decoration:none;border-left-style:none;border-left-width:1px;border-left-color:#000000;border-top-style:none;border-top-width:1px;border-top-color:#000000;border-right-style:none;border-right-width:1px;border-right-color:#000000;border-bottom-style:solid;border-bottom-width:1px;border-bottom-color:#000000;background-color:#FFFFFF;white-space:nowrap;overflow:hidden;word-break:keep-all;}
...
<table id="report1" cellSpacing=0 cellPadding=0 selectText=yes onmouseout="report1457161out()" onmouseover="report1457161over()" rowCount=11 cols=8 submitCells="2" ajaxUrl="/WSSBSL/reportServlet" offSvr="/WSSBSL/servlet/saveLineoffInput" style="width:799px;table-layout:fixed;border-collapse:collapse">
	<colgroup>
	...
	<tr rn="1" height=40 style="height:40px;">
		<td colSpan=8 id="report1_A1" colNo=1 value='增值税纳税申报表附列资料（四）' onclick="_hideEditor()" class="report1_9">增值税纳税申报表附列资料（四）</td>
	</tr>
	<tr rn="2" height=20 style="height:20px;">
		<td colSpan=8 id="report1_A2" colNo=1 value='（税额抵减情况表）' onclick="_hideEditor()" class="report1_8">（税额抵减情况表）</td>
	</tr>
	<tr rn="3" height=20 style="height:20px;">
		<td colSpan=2 id="report1_A3" colNo=1 value='纳税人识别号：' onclick="_hideEditor()" class="report1_5">纳税人识别号：</td>
		<td colSpan=2 id="report1_C3" colNo=3 value='' onclick="_hideEditor()" class="report1_7"></td>
	...
	<tr rn="4" height=35 style="height:35px;">
		<td colSpan=2 id="report1_A4" colNo=1 value='纳税人名称：' onclick="_hideEditor()" class="report1_5">纳税人名称：</td>
		<td colSpan=2 id="report1_C4" colNo=3 value='' onclick="_hideEditor()" class="report1_6"></td>
	...
	<tr rn="7" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_B7" colNo=2 value='增值税税控系统专用设备费及技术维护费' onclick="_hideEditor()" class="report1_6">增值税税控系统专用设备费及技术维护费</td>
		<td id="report1_D7" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td id="report1_E7" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
		<td id="report1_F7" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_3">0.00</td>
		<td id="report1_G7" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
	...
	<tr rn="8" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_B8" colNo=2 value='分支机构预征缴纳税款 ' onclick="_hideEditor()" class="report1_6">分支机构预征缴纳税款&nbsp;</td>
		<td id="report1_D8" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td id="report1_E8" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
		<td id="report1_F8" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_3">0.00</td>
		<td id="report1_G8" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
	...
	<tr rn="9" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_B9" colNo=2 value='建筑服务预征缴纳税款 ' onclick="_hideEditor()" class="report1_7">建筑服务预征缴纳税款&nbsp;</td>
		<td id="report1_D9" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td id="report1_E9" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
		<td id="report1_F9" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_3">0.00</td>
		<td id="report1_G9" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
	...
	<tr rn="10" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_B10" colNo=2 value='销售不动产预征缴纳税款 ' onclick="_hideEditor()" class="report1_7">销售不动产预征缴纳税款&nbsp;</td>
		<td id="report1_D10" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td id="report1_E10" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
		<td id="report1_F10" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_3">0.00</td>
		<td id="report1_G10" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
	...
	<tr rn="11" height=20 style="height:20px;">
		...
		<td colSpan=2 id="report1_B11" colNo=2 value='出租不动产预征缴纳税款' onclick="_hideEditor()" class="report1_7">出租不动产预征缴纳税款</td>
		<td id="report1_D11" colNo=4 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_2">0.00</td>
		<td id="report1_E11" colNo=5 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
		<td id="report1_F11" colNo=6 value='0.0' format="%230.00" digits="2" onclick="_hideEditor()" class="report1_3">0.00</td>
		<td id="report1_G11" colNo=7 modifiable=true writable=true editStyle="1" inputDataType="2" value='0.0' format="%230.00" digits="2" onclick="_displayEditor()" class="report1_4">0.00</td>
...
<div style="display:none"><form id="report1_submitForm" method=post action="/WSSBSL/reportServlet.aspx?action=11" target="submitFrame">
	...
	<input type=hidden name=cachedId value="10_1_1_176_8080_41504">
	<input type=hidden name=pageUrl value="/WSSBSL/reportJsp/showReport.jsp?raq=%2Fzzs2013Ybnsr%2FybnsrFb4.raq&nsrsbh=450100399111430&sbzt=0&skssq=20171111&ssqq=2017-11-01&ssqz=2017-11-30&isTbBz=0&reportParamsId=15123563587574147140642">
