<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SB104xqykjzzcwbsCtrl_toSbfb_04.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SB104xqykjzzcwbsCtrl_toSbfb_04" %>
...
<html>
	<head>
		...
		<script language='javascript' type='text/javascript'
			src='../../sb/sb104/sb104_xjllbnbb.js'></script>
	...
	<!-- 缓存 -->
		<div class="wrapper">
			...
			<div sword="SwordForm" name="nsrxxForm5" caption="纳税人基本信息"
			...
			<div sword="SwordForm" name="xjllbxxnbbForm"
				...
				<table class="tab_form" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td>
							<div name="h16l3" type="text" defValue="0.00" rule="number_must"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div name="h21l3" type="text" defValue="0.00" rule="number_must"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
...
<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"96bb09c768664d7d801d42d3032f48b5","type":""}]}'></div>
