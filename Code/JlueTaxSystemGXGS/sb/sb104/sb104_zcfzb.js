...
function sqzcfzbxxOnSuccess(req, resData) {
    ...
    if (zcfzbxxlist && zcfzbxxlist.trs.length > 0) {
        sncjbz = "Y";
    }
}
/**
...
function openTab(inputEl) {
    ...
    if (name == '00') {
        ...
        if (!sb101_boolean_fb01) {// 没有打开过
            table01iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb02) {// 没有打开过
            table02iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb03) {// 没有打开过
            table03iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb04) {// 没有打开过
            table04iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb05) {// 没有打开过
            table05iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb06) {// 没有打开过
            table06iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb07) {// 没有打开过
            table07iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb08) {// 没有打开过
            table08iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb09) {// 没有打开过
            table09iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
        ...
        if (!sb101_boolean_fb10) {// 没有打开过
            table10iframe.src = AddBizCode2URL("/sword.ashx?ctrl=SB104xqykjzzcwbsCtrl_toSbfb&id=" + name);
...
function openTabYd(inputEl) {
    ...
    if (name == '00') {
        ...
        table01.setStyle('display', '');
        if (!sb101_boolean_fb01) {// 没有打开过
            table01iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbYd&id=" + name);
            sb101_boolean_fb01 = true;
        }
    }
}
function openTabZq(inputEl) {
    ...
    if (name == '00') {
        ...
        table01.setStyle('display', '');
        if (!sb101_boolean_fb01) {// 没有打开过
            table01iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbZq&id=" + name);
            sb101_boolean_fb01 = true;
        }
    }
}
function openTabNd(inputEl) {
    ...
    if (name == '00') {
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb03) {// 没有打开过
            table03iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb03 = true;
        }
    } else if (name == '04') {
        buDisable();
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb04) {// 没有打开过
            table04iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb04 = true;
        }
    } else if (name == '05') {
        buDisable();
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb05) {// 没有打开过
            table05iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb05 = true;
        }
    } else if (name == '06') {
        buDisable();
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb06) {// 没有打开过
            table06iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb06 = true;
        }
    } else if (name == '07') {
        buDisable();
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb07) {// 没有打开过
            table07iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb07 = true;
        }
    } else if (name == '08') {
        buDisable();
        ...
        table10.setStyle('display', 'none');
        if (!sb101_boolean_fb08) {// 没有打开过
            table08iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb08 = true;
        }
    } else if (name == '09') {
        buDisable();
        ...
        table10.setStyle('display', '');
        if (!sb101_boolean_fb10) {// 没有打开过
            table10iframe.src = AddBizCode2URL("/sword?ctrl=SB104xqykjzzcwbsCtrl_toSbfbNd&id=" + name);
            sb101_boolean_fb10 = true;
        }
    } else {
        zlbstofb(name, zlbsxlDm, nsrxxMapInit);
