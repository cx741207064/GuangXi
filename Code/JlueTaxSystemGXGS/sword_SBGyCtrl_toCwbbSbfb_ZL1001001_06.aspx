<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SBGyCtrl_toCwbbSbfb_ZL1001001_06.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SBGyCtrl_toCwbbSbfb_ZL1001001_06" %>
...
<script type="text/javascript" src="/gt3_public/cacheindex.js"></script>
	...
	<!-- 缓存 -->	
		<div class="wrapper" style="width: 100%">
			...
			<div sword='SwordGrid' name="fyazxzfldbcclGrid" caption="费用按照性质分类的补充资料"
				checkMoudle="false" fenye="false" showConsole="true" dataX="100%"
				dataY="300" showHJ="true" autoHeight="false" onAfterCreateRow="createRow()">
				<div name="xmmc" caption="项目" rule="must" type="text" x="40%" onblur="changexmmc()" isHjLabel="true"></div>
				<div name="bqje" caption="本期金额" rule="must_number(18,2)" type="text" hj="true" x="30%"></div>
				<div name="sqje" caption="上期金额" rule="must_number(18,2)" type="text" hj="true" x="30%"></div>
...
<div name="qxBtn" sword="SwordSubmit" btnName="重置" isShow="true"
		...
		<script language="javascript" type="text/javascript"
			src="../../sb/gycwbb/sb000_fyazxzfldbcsm.js"></script>
	</body>
</html>

<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501070500","type":""},{"name":"sessionID","value":"3493626ee395479baa5a9a92e2a50e75","type":""}]}'></div>
