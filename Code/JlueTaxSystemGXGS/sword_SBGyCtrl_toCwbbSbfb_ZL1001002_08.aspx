<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SBGyCtrl_toCwbbSbfb_ZL1001002_08.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SBGyCtrl_toCwbbSbfb_ZL1001002_08" %>
...
<script type="text/javascript" src="/gt3_public/cacheindex.js"></script>
	...
	<!-- 缓存 -->
		<div class="wrapper" style="width: 100%">
			...
			<div sword='SwordGrid' name="wxzcdplGrid" caption="无形资产的披露（适用执行企业会计制度的企业）"
				checkMoudle="false" fenye="false" showConsole="true" dataX="100%"
				dataY="300" showHJ="true" autoHeight="false"  onAfterCreateRow="disable()">
				<div name="zl1" caption="种类"   type="text" x="14%"></div>
				<div name="sjcb" caption="实际成本"  rule="number(18,2)" type="text" x="14%"></div>
				<div name="qcye" caption="期初余额" rule="number(18,2)" type="text" x="14%"></div>
				<div name="bqzj" caption="本期增加" rule="number(18,2)" type="text" x="14%"></div>
				<div name="bqzc1" caption="本期转出" rule="number(18,2)" type="text" x="14%"></div>
				<div name="bqtx" caption="本期摊销" rule="number(18,2)"  type="text" x="14%"></div>
				<div name="qmye" caption="期末余额" rule="number(18,2)" type="text" x="14%"></div>
...
<div name="qxBtn" sword="SwordSubmit" btnName="重置" isShow="true"
		...
		<script language="javascript" type="text/javascript"
			src="../../sb/gycwbb/sb000_wxzcdpl.js"></script>
	</body>
</html>

<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"a839cb4bb8e44d8484bcf75611177dc9","type":""}]}'></div>
