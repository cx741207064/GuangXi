<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SB104xqykjzzcwbsCtrl_toSbfb_07.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SB104xqykjzzcwbsCtrl_toSbfb_07" %>
...
<html>
	<head>
		...
		<script language='javascript' type='text/javascript'
			src='../../sb/sb104/sb104_gdzcdpl.js'></script>
	...
	<!-- 缓存 -->
		<div class="wrapper">
			...
			<div sword="SwordForm" name="gdzcdplForm" caption="固定资产的披露（适用执行小企业会计准则的企业）"
				...
				<table class="tab_form" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td>
							<div name="h6l4" type="text" defValue="0.00" rule="number_must"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div name="h7l4" type="text" defValue="0.00" rule="number_must"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div name="h8l2" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h8l3" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h8l4" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
...
<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"ebe6b4f7a56443bab3baa5deac2e0e29","type":""}]}'></div>
