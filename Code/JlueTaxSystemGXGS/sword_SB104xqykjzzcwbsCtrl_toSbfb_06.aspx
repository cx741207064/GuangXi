<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SB104xqykjzzcwbsCtrl_toSbfb_06.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SB104xqykjzzcwbsCtrl_toSbfb_06" %>
...
<html>
	<head>
		...
		<script language='javascript' type='text/javascript'
			src='../../sb/sb104/sb104_dqtzdpl.js'></script>
	...
	<!-- 缓存 -->
		<div class="wrapper">
			...
			<div sword="SwordForm" name="dqtzdplForm" caption="短期投资的披露（适用执行小企业会计准则的企业）"
				...
				<table class="tab_form" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td>
							<div name="h5l2" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h5l3" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
						<td>
							<div name="h5l4" type="text" defValue="0.00" rule="number_must" disable="true"
								format="{'type':'number','format':'#,##0.00'}"
								style="text-align: right"></div>
						</td>
					</tr>
...
<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"e724400a712e4b8f9e17a63cf4fc19a4","type":""}]}'></div>
