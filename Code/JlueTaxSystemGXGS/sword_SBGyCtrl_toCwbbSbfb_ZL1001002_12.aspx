<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sword_SBGyCtrl_toCwbbSbfb_ZL1001002_12.aspx.cs" Inherits="JlueTaxSystemGXGS.sword_SBGyCtrl_toCwbbSbfb_ZL1001002_12" %>
...
<script type="text/javascript" src="/gt3_public/cacheindex.js"></script>
	...
	<!-- 缓存 -->
		<div class="wrapper" style="width: 100%">
			...
			<div sword="SwordForm" name="dqtzdplForm"
				caption="短期投资的披露（适用执行企业会计制度的企业）" panel="true" vType="fldiv"
				userdefine="true">
...
<div name="qxBtn" sword="SwordSubmit" btnName="重置" isShow="true"
		...
		<script language="javascript" type="text/javascript"
			src="../../sb/gycwbb/sb000_dqtzdpl.js"></script>
	</body>
</html>

<div id="SwordPageData"  style='display:none' data='{"data":[{"name":"gwssswjg","value":"14501950500","type":""},{"name":"sessionID","value":"3c1efbb376534d52aa6a5741ed8071fd","type":""}]}'></div>
